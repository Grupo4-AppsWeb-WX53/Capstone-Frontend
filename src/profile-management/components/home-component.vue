...
import {RandomUsersApiService} from "@/profile-management/services/random-user-api-service";
export default {
  name: 'home',
  data() {
    return {
  ...
  methods: {
    ...
    getParticipants() {
      axios
          ...
          .catch(error => {
            // Maneja los errores de la llamada a la API aquí
            console.error(error);
          });
    },
  },
